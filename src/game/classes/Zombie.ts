...
export default class Zombie {
    ...
    constructor(scene: Phaser.Scene | null, gridX: number, gridY: number, texture: string = 'Zombie') {
        this.scene = scene;
        this.i = gridX;
        this.j = gridY;
        ...
        if (scene) {
            ...
            this.sprite = this.scene?.add.sprite(x, y, texture).setOrigin(0.5).setScale(0.5) || null;
        } else {
